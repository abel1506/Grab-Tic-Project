...
class Movie(BaseClass):
    ...
    # certification = models.CharField(max_length=20,choices=CerificationChoices.choices)
    certification = models.ForeignKey('Certification',on_delete=models.CASCADE)

    # languages = MultiSelectField(max_length=20,choices=LanguageChoices.choices)
