...
from . models import Movie,CastChoices,GenreChoices,LanguageChoices,CerificationChoices
...
# normal way to get all fields and add record
...
#         data = {'language_choices':LanguageChoices,
...
#         # print(name,description,photo,run_time,release_date,cast,language,genre)
